...
typedef struct  //Палитра цветов BMP-изображения
{
...
struct img   //информация о BMP-изображении
{
	img(int w, int h) //param w Ширина изображения, param h Высота изображения.
	{
		x_size = w;
		y_size = h;
	}
